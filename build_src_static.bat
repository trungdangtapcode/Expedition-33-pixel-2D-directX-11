...
set CL_FLAGS=/MP /std:c++17 /EHsc /W3 %CRT_FLAG% %OPT_FLAG% /DUNICODE /D_UNICODE /D_CRT_SECURE_NO_WARNINGS /D__CRT_SECURE_NO_WARNINGS /D_CRT_SECURE_NO_WARNINGS /I "%MSVC_DIR%\include" /I "%WINSDK_DIR%\Include\%WINSDK_VER%\um" /I "%WINSDK_DIR%\Include\%WINSDK_VER%\shared" /I "%WINSDK_DIR%\Include\%WINSDK_VER%\ucrt" /I "%WINSDK_DIR%\Include\%WINSDK_VER%\winrt" /I "%VCPKG_DIR%\include" /I "%VCPKG_DIR%\include\directxtk" /I "src"
