...
set CL_SOURCES=%CL_SOURCES% src\Battle\ConsumeMpAction.cpp src\Battle\DataDrivenSkill.cpp src\Battle\DataDrivenStatusEffect.cpp src\Battle\SkillFactory.cpp src\Battle\StatusDamageAction.cpp src\Battle\StatusEffectRegistry.cpp src\UI\StatusIconRenderer.cpp src\UI\BattleSkillMenuRenderer.cpp
