...
- Basic attacks, advanced debuff attacks, AoE fire, and rage finishers use `queued` timing so several prompts can appear near each other without allowing simultaneous input ownership.
