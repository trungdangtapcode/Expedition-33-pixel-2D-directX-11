...
class SpiralSpawner : public IBulletSpawner {
public:
    SpiralSpawner(const JsonLoader::BulletSpawnerData& data, int textureIdx)
        : mData(data), mTextureIndex(textureIdx), mSpawnTimer(0.0f), mCurrentAngle(0.0f) {}
